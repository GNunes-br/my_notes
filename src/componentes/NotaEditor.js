...
import { adicionaNota, atualizaNota, deletaNota } from '../servicos/Notas'
...
export default function NotaEditor({ mostraNotas, notaSelecionada, setNotaSelecionada }) {
  ...
  async function deleta() {
    await deletaNota(notaSelecionada)
    limpaModal()
    mostraNotas()
  }
          ...
          <ScrollView showsVerticalScrollIndicator={false}>
            <View style={estilos.modal}>
              ...
              <View style={estilos.modalBotoes}>
                <TouchableOpacity style={estilos.modalBotaoSalvar} onPress={notaParaAtualizar ? atualiza : salva}>
                  <Text style={estilos.modalBotaoTexto}>Salvar</Text>
                </TouchableOpacity>
                {notaParaAtualizar && 
                <TouchableOpacity style={estilos.modalBotaoDeletar} onPress={deleta}>
